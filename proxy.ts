...
const publicApiPaths = ["/api/external", "/api/test", "/api/notifications", "/api/sync-dockets", "/api/sync-costing-smartsheet", "/api/sync-bom", "/api/health", "/api/sync-to-merged", "/api/admin/reset-password"]
