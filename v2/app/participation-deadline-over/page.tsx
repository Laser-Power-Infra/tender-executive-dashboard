      ...
      <div className="dashboard-workspace">
        ...
        <main className="dashboard-body">
          {loadingTenders && !tenderSliceData ? (
            ...
            <>
              <TenderTable records={activeDataset} clearTrigger={clearTrigger} readOnly={true} editableColumns={["participated"]} showPostParticipationColumns={true} defaultEndDate={todayStr} />
            </>
          )}
        </main>
